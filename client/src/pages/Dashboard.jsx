...
const s = {
  ...
  select: { padding: '9px 12px', border: '1.5px solid #ddd6fe', borderRadius: '10px', fontSize: '14px', background: '#f5f3ff', color: '#1e1b4b', cursor: 'pointer', outline: 'none', transition: 'border-color 0.15s' },
  input: { padding: '9px 12px', border: '1.5px solid #ddd6fe', borderRadius: '10px', fontSize: '14px', background: '#f5f3ff', color: '#1e1b4b', outline: 'none', width: '100%', transition: 'border-color 0.15s, box-shadow 0.15s' },
